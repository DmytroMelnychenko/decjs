...
// htmlBlock.classList.add('wrap','collapse','alpha','beta');
// document.body.append(htmlBlock);
// htmlBlock.style.background = 'coral';
// htmlBlock.style.width = '300px';
// htmlBlock.style.height = '100px';
// htmlBlock.innerText = 'QWERTY';
// htmlBlock.style.fontSize = '60px';
// let body = document.querySelector('body');
// body.appendChild(htmlBlock);
// // document.body.append(htmlBlock.cloneNode(/!*true*!/));
// let clone = htmlBlock.cloneNode(true);
...
// let liArray = ['Main','Products','About us','Contacts'];
// let body = document.querySelector('body');
...
//     divElem.innerText = `title: ${item.title} - monthDuration: ${item.monthDuration}`;
...
// // з monthDuration елементу.Завдання робити через цикли.
//
...
// данними з об'єкту. Якщо людською мовою: під кожного члена родини зробити блок та наповнити
...
//         li.innerText = module;
//         li.classList.add('coral', 'list-none');
//         ul.appendChild(li);
//     }
//
//     block.classList.add('main');
//     title.classList.add('text-centr', 'coral');
//     duration.classList.add('flex');
//     month.classList.add('coral', 'text-centr', 'grow1');
//     hour.classList.add('coral', 'text-centr', 'grow5');
//     ul.classList.add('margin0', 'coral');
//
...
// p.innerText = 'зробіть так, щоб при натисканні на кнопку зникав елемент з id="text"';
//
//  btn.innerText = 'CLICK';
//  btn.onclick = () => {
...
// const form = document.forms.checkin;
